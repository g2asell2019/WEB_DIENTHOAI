...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 01, 2023 at 04:47 AM
...
CREATE TABLE `orders` (
  ...
  `receiving_point` varchar(255) DEFAULT NULL,
  `total_value` decimal(10,0) DEFAULT NULL,
  `note` varchar(255) DEFAULT NULL,
  `order_idUser` int(11) DEFAULT NULL,
  `createdAt` datetime NOT NULL,
  `updatedAt` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
('migration-create-categories.js'),
('migration-create-discount.js'),
('migration-create-feedback.js'),
('migration-create-orderdetails.js'),
('migration-create-orders.js'),
('migration-create-products.js'),
('migration-create-sales.js'),
('migration-create-user.js'),
('migrattion-create-allcode.js');
...
ALTER TABLE `products`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idCate` (`idCate`,`idBrand`,`idSale`);
