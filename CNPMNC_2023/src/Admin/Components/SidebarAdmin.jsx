...
const SidebarAdmin = () => {
  return (
    <div className="col-md- col-lg-2 sidebar-offcanvas pl-0" id="sidebar" role="navigation" style={{ backgroundColor: "#e9ecef" }}>
      <Nav defaultActiveKey="/home" className="flex-column sticky-top pl-0 pt-5 p-0 mt-3">
        <li className="nav-item mb-2 mt-3">
          <a className="nav-link text-secondary" href="/"><h5>Nguyễn Tuấn Anh</h5></a>
        </li>
        <li className="nav-item mb-2 ">
          <a className="nav-link text-secondary" href="profile">
            <i className="fas fa-user font-weight-bold"></i> <span className="ml-3">Thông tin cá nhân</span>
